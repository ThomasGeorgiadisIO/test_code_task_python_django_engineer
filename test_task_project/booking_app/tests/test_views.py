...
class TestReservationListView(TestCase):
    ...
    def setUp(self):
        ...
        self.reservation3 = Reservation.objects.create(rental=self.rental2, checkin="2022-05-05", checkout="2022-05-10")
        self.reservation4 = Reservation.objects.create(rental=self.rental2, checkin="2022-05-12", checkout="2022-05-15")
    ...
    def test_view_uses_correct_rental_order(self):
        ...
        self.assertTrue(all(e.rental==self.rental1 for e in reservation_with_rental1_list))
        self.assertTrue(all(e.rental==self.rental2 for e in reservation_with_rental2_list))
